...
-- SELECT "username", "account_balance" FROM "accounts"
-- ORDER BY "account_balance" ASC (although default is low-high without asc)
-- LIMIT 3;
...
-- Add a new record.
-- INSERT INTO accounts (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('Kristen', 'Maple Grove', 111, 222, 12345.67);
...
-- WHERE "city" IN ('miami', 'chicago') AND "transactions_attempted" < 5;
